...
Candidate source proposal。下一条slice只依据这份unbuilt artifact与实际target/toolchain事实选择最短build
consumer；revision、CUDA/Ascend execution、verdict、performance、knowledge/skill、feedback和platform/release仍按
