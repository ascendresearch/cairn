...
| DEV-014 | InProgress | [`first receipt-bound Candidate revision`](DEV-014-IMPLEMENTATION.md) | 新isolated DeepSeek episode消费exact receipt-bound diagnostic并提交parent-linked full-source revision |
