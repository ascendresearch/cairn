//! Deterministic host fixture implementing the isolated call-adapter process protocol.
//!
//! This executable validates protocol transport and emits zero-filled outputs. It is not an
//! operator oracle or a production host executor.
