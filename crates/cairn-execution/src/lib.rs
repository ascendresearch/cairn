...
pub use worker::{
    ...
    TrustedWorkerResourceAdmission, WorkerAuthenticationError, WorkerAuthenticationSubject,
    ...
    WorkerResourceObservation, WorkerResourceObservationArtifact, WorkerResourceSource,
    WorkerSessionState, WorkerSessionTimeoutMillis, WorkerSlotCount, WorkerValueError,
