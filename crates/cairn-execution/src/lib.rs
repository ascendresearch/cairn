...
pub use control::{
    ...
    assignment_offer_message, controller_outbox_position, decode_control_frame,
    ...
    invoke_recovered_worker_executor, invoke_worker_executor, load_assignment_material_manifest,
    pending_controller_messages, pending_worker_messages, read_assignment_material_chunk,
    reconcile_worker_result, record_worker_execution_observation, record_worker_execution_start,
...
pub use worker::{
    ...
    RegisteredWorkerSession, ReservationClaimTimeoutMillis, ResourceProbeVersion, SessionEndReason,
    ...
    WorkerResourceObservationArtifact, WorkerResourceSource, WorkerSessionState, WorkerSlotCount,
    WorkerValueError, admit_trusted_worker_resource_observation, disconnect_worker,
    lapse_worker_session, match_worker, match_worker_at, record_worker_heartbeat,
    record_worker_resource_observation, recover_worker_session, register_worker,
