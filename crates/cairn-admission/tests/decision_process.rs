...
use cairn_admission::{
    ...
    CollectionOutputIntentV1, CollectionOutputOraclePolicyV1, CollectionOutputOrderContractV1,
    CollectionReportedCount, ExpectedCollectionOracleOutputV1, IntentAdmissionPublicOutcomeV1,
    ObservedCollectionOracleOutputV1, TaskIntentAuthoritySubject, UserIntentAuthorityGrantArtifact,
